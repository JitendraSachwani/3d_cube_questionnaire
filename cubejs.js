...
function quest1a()
{
  ...
  if(count1==2 && ans1.value=="696")
  {
    ...
    setTimeout(function(){
      document.getElementById("side1").innerHTML="<img id=\"q1a\" src=\"./images/1b.jpg\" style=\"height:400px; width:400px; opacity:1;\"/><form onsubmit=\"return false\"><span id=\"form1\" style=\"font-size:20px\" >Ans :-</span><input id=\"ans1\" type=\"text\"><input value=\"Check\" name=\"button1\" type=\"button\" onClick=\"quest1a();\"></form>";
    },1000);
  ...
  else if(count1==1 && ans1.value=="81")
  {
    ...
    q3.style.opacity="0";
    setTimeout(function(){
      document.getElementById("side1").innerHTML="<img id=\"q1a\" src=\"./images/orange.jpg\" style=\"height:400px; width:400px; opacity:1;\"/>";
      count1--;
      count--;
      solved();
    },1000);
...
function quest2a()
{
  if(count2==2 && ans2.value=="13")
  {
    ...
    //Question 1b image in next innerHTML url
    setTimeout(function(){
      document.getElementById("side2").innerHTML="<img id=\"q2a\" src=\"./images/2b.jpg\" style=\"height:400px; width:400px; opacity:1;\"/><form onsubmit=\"return false\"><span id=\"form2\" style=\"font-size:20px\" >Ans :-</span><input id=\"ans2\" type=\"text\"><input value=\"Check\" name=\"button2\" type=\"button\" onClick=\"quest2a();\"></form>";
    },1000);
  ...
  else if(count2==1 && ans2.value=="D")
  {
    ...
    q3.style.opacity="0";
    setTimeout(function(){
      document.getElementById("side2").innerHTML="<img id=\"q2a\" src=\"./images/red.jpg\" style=\"height:400px; width:400px; opacity:1;\"/>";
      count2--;
      count--;
      solved();
    },1000);
...
function quest3a()
{
  if(count3==2 && ans3.value=="4")
  {
    ...
    //Question 1b image in next innerHTML url
    setTimeout(function(){
      document.getElementById("side3").innerHTML="<img id=\"q3a\" src=\"./images/3b.jpg\" style=\"height:400px; width:400px; opacity:1;\"/><form onsubmit=\"return false\"><span id=\"form3\" style=\"font-size:20px\" >Ans :-</span><input id=\"ans3\" type=\"text\"><input value=\"Check\" name=\"button3\" type=\"button\" onClick=\"quest3a();\"></form>";
    },1000);
  ...
  else if(count3==1 && ans3.value=="5")
  {
    ...
    q3.style.opacity="0";
    setTimeout(function(){
      document.getElementById("side3").innerHTML="<img id=\"q3a\" src=\"./images/green.jpg\" style=\"height:400px; width:400px; opacity:1;\"/>";
      count3--;
      count--;
      solved();
    },1000);
...
function quest4a()
{
  if(count4==2 && ans4.value=="fivehundred")
  {
    ...
    //Question 1b image in next innerHTML url
    setTimeout(function(){
      document.getElementById("side4").innerHTML="<img id=\"q4a\" src=\"./images/4b.jpg\" style=\"height:400px; width:400px; opacity:1;\"/><form onsubmit=\"return false\"><span id=\"form4\" style=\"font-size:20px\" >Ans :-</span><input id=\"ans4\" type=\"text\"><input value=\"Check\" name=\"button4\" type=\"button\" onClick=\"quest4a();\"></form>";
    },1000);
  ...
  else if(count4==1 && ans4.value=="-72")
  {
    ...
    q3.style.opacity="0";
    setTimeout(function(){
      document.getElementById("side4").innerHTML="<img id=\"q4a\" src=\"./images/purple.jpg\" style=\"height:400px; width:400px; opacity:1;\"/>";
      count4--;
      count--;
      solved();
    },1000);
